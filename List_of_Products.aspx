<%@ Page Title="" Language="C#" MasterPageFile="~/customer.master" AutoEventWireup="true" CodeFile="List_of_Products.aspx.cs" Inherits="List_of_Products" %>
    ...
    <table style="width: 100%">
        <tr>
            <td colspan="3" valign="top">
                <h4>
                    <span style="color: #cc0000"><strong>List of Products </strong></span></h4>
            </td>
        </tr>
        <tr>
            <td colspan="3" valign="top">
