<%@ Page Language="C#" MasterPageFile="~/customer.master" AutoEventWireup="true" CodeFile="product_details1.aspx.cs" Inherits="product_details" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table width="100%">
        ...
        <tr>
            <td rowspan="2" style="width: 468px" valign="top">
