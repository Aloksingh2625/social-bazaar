<%@ Page Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="products.aspx.cs" Inherits="products" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<table style="width: 100%">
        <tr>
            <td colspan="3" valign="top">
                <h4>
                    <span style="color: #cc0000"><strong>Painding Products for Apporoval</strong></span></h4>
            </td>
        </tr>
        <tr>
            <td colspan="3" valign="top">
                <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" AutoGenerateColumns="False" Width="679px">
                    ...
                    <Columns>
                        ...
                        <asp:HyperLinkField DataNavigateUrlFields="PID,pname,category,description,photo,price,date"
                            DataNavigateUrlFormatString="confirm_products_approve.aspx??PID={0} &amp;pname={1} &amp;category={2} &amp;description={3} &amp;photo={4} &amp;price={5} &amp;date={6}"
                            HeaderText="Approved" Text="Approved" />
                    </Columns>
